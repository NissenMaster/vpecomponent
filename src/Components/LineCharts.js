...
import { defaultLineOption } from "../Utils/ComponentDefaultData";
...
export default class LineCharts extends PureComponent {
  ...
  resize = chart => {
    setOption(this.props.option, chart, defaultLineOption);
    chart && chart.resize();
  };
  ...
  drawChart = () => {
    ...
    setOption(this.props.option, this.chart, defaultLineOption);
  };
